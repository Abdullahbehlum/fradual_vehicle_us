    ...
    <section id="car-report">
        <div class="parallex-section">
            ...
            <div class="parallex-bike_content">
                <div>
                    <h2>Boat History Report
                    </h2>
                    <h6>Discover Serenity with Our Thorough Boat Inspections
                        .</h6>
                </div>
                <ul class="breadcumb">
                    <li>
            ...
            <div class="car_report_contain">
                <div class="car_report_wrap">
                    ...
                    <div class="right_side">
                        <h6>WE ‘RE ONE</h6>
                        <h2 data-aos="fade-up" data-aos-duration="2000">We are a big team obsessed with <br>
                            productivity</h2>
                        <div class="report_right_h_wrap">
                            ...
                            <img src="{{ asset('/assets/1669367352_652309_gif-url.jpeg.webp') }}" alt="Ins_peration"
                                width="382">
                        </div>
                    </div>
                </div>
            ...
            <div class="packages_container">
                <div class="pricing_container">
                    ...
                    <div class="pric_col" data-aos="fade-up" data-aos-duration="6000">
                        ...
                        <a href="/check-out?package=basic-boat-report&price=40.75">
                            Buy Now
                        </a>
                    </div>

                    <div class="pric_col" data-aos="fade-up" data-aos-duration="4000">
                        <h3>
                            Elite Boat Report
                        </h3>
                        <div class="pack_pric_container">
                            <h2 class="package_amount">$60</h2>
                            <h5 class="pack_dc">.75</h5>
                        </div>
                        <p>Delivery Duration: 2 Hours</p>
                        <ul class="pric_list">
                        ...
                        <a href="/check-out?package=elite-boat-report&price=60.75">
                            Buy Now
                        </a>
                    </div>
